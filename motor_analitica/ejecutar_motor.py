...
# Configurar Flask y BD usando la configuración compartida en `common`
app = create_app()
# Cargar valores adicionales desde la clase Config (JWT_SECRET, REE_API_TOKEN, etc.)
...
def ejecutar_motor():
    ...
    with app.app_context():
        ...
        print("="*80)
        print("\nPuedes ver los resultados en: http://127.0.0.1:5002/dashboard")
